/**
* This file is part of ORB-SLAM3 - Headless version for testing
*/
...
int main(int argc, char **argv)
{
    if(argc != 4)
    {
        cerr << endl << "Usage: ./mono_kitti_headless path_to_vocabulary path_to_settings path_to_sequence" << endl;
        return 1;
    }
    ...
    // Create SLAM system WITHOUT viewer (false parameter)
